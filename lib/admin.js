 ...
 * var admin = new Neb().admin;
 * admin.unlockAccount({
 *     address: "8a209cec02cbeab7e2f74ad969d2dfe8dd24416aa65589bf",
 ...
 * @example
 * var admin = new Neb().admin;
 * admin.lockAccount({address: "8a209cec02cbeab7e2f74ad969d2dfe8dd24416aa65589bf"}).then(function(isLocked) {
 * //code
 * });
 */
